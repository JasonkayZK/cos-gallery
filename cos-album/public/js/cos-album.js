...
Cosalbum = function Cosalbum() {
  ...
  var _renderDom = function (cosAlbum) {
    ...
    $cosAlbumEle.className = 'cos-gallery';
  ...
  var _addClickListener = function ($media) {
  ...
  /**
   * 创建 Powered By cos-gallery
   * @param {String} version 版本号
   */
  var _createPowerEle = (version) => {
    let $cosAlbumEle = document.querySelector('.cos-gallery');
    let $caPowerEle = document.createElement('div');
    let $caPowerLink = document.createElement('a');
    $caPowerLink.href = 'https://github.com/Jasonkayzk/cos-gallery';
    $caPowerLink.target = '_blank';
    $caPowerLink.innerHTML = 'cos-gallery';
